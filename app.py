...
def show_input_step1():
    ...
    st.markdown("<h3 style='font-family: Kanit, sans-serif; font-weight: 400;'>🧬 ข้อมูลพฤติกรรมและการจัดการ</h3>", unsafe_allow_html=True)
    
    st.info("💡 โปรดทราบ: 0 = ไม่มี, 1 = น้อยที่สุด, 5 = มากที่สุด")

    # --- แก้ไขจุดสำคัญ: กำหนดตัวเลือกคะแนน 0 ถึง 5 ให้เป็น List ที่ถูกต้อง ---
    # ต้องเขียนเป็น [1-5] แบบนี้เท่านั้น
    ...
    with st.form("form_step1"):
        ...
        # ปุ่ม Submit (ต้องอยู่ภายใน with st.form และย่อหน้าเดียวกับ col1, col2)
