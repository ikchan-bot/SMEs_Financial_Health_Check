...
def show_input_step1():
    ...
    st.info("💡 กรุณาเลือกระดับการดำเนินงานในปัจจุบันของกิจการท่านตามความเป็นจริงโดยที่<br>0 = ไม่มี/ไม่ได้ดำเนินงาน| 1 = น้อยที่สุด| 2 = น้อย| 3 = ปานกลาง| 4 = มาก| 5 = มากที่สุด")
...
def show_input_step2():
    ...
    st.info("💡 โปรดเลือกระดับการดำเนินงาน/สถานะปัจจุบันของกิจการตามความเป็นจริงโดยที่<br>0 = ไม่มี| 1 = น้อยที่สุด| 2 = น้อย| 3 = ปานกลาง| 4 = มาก| 5 = มากที่สุด")
