...
def show_input_step1():
    ...
    st.info("💡 โปรดเลือกระดับการดำเนินงานของกิจการโดยที่ 0 = ไม่มี, 1 = น้อยที่สุด, 5 = มากที่สุด")

    # ตัวเลือกคะแนน
    score_options = [0 ไม่มี, 1 น้อยที่สุด, 2 น้อย, 3 ปานกลาง, 4 มาก, 5 มากที่สุด]
