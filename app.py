...
def show_input_step1():
    ...
    # --- แก้ไข 1: กำหนดตัวเลือกคะแนนให้ถูกต้อง (เป็น List ของตัวเลข 0-5) ---
    score_options = [1-5]
    ...
    with st.form("form_step1"):
        ...
        with col1:
            ...
            # ใช้ score_options ที่ประกาศไว้
        ...
        # --- แก้ไข 2: ปุ่ม Submit ต้องอยู่ย่อหน้าเดียวกับ col1, col2 (ภายใน with st.form) ---
