...
def show_dashboard():
    ...
    cluster_info = {
        0: {"name": "The Traditional Marketer (นักการตลาดแบบดั้งเดิม)", "desc": "เก่งสร้างแบรนด์และการขาย แต่ขาดระบบป้องกันความเสี่ยงและเทคโนโลยี", "color": "#f1c40f"}, # สีเหลือง
        1: {"name": "The Vulnerable Laggard (กลุ่มเปราะบาง)", "desc": "ขาดความพร้อมทั้งด้านการเงิน การตลาด และระบบจัดการ มีความเสี่ยงสูง", "color": "#e74c3c"},   # สีแดง
        2: {"name": "The Resilient Leader (ผู้นำรอบด้าน)", "desc": "มีความพร้อมครบทุกด้าน ทั้งการเงิน การตลาด และระบบจัดการความเสี่ยง", "color": "#2ecc71"}    # สีเขียว
    }
    ...
    with col1:
        ...
        if cluster_id == 1:
            st.warning("⚠️ ธุรกิจของท่านมีความเปราะบาง ควรเร่งสร้างวินัยการเงินและวางระบบบัญชีโดยด่วน")
        elif cluster_id == 0:
            st.info("ℹ️ ท่านมีจุดแข็งด้านการตลาด แต่ควรเพิ่มระบบจัดการความเสี่ยงและเทคโนโลยีเพื่อความยั่งยืน")
        else:
            st.success("✅ ท่านมีความพร้อมสูง สามารถยื่นขอสินเชื่อเพื่อขยายกิจการได้เลย")
